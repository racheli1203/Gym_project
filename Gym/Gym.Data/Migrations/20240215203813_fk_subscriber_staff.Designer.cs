...
namespace Gym.Data.Migrations
{
    ...
    [Migration("20240215203813_fk_subscriber_staff")]
    partial class fk_subscriber_staff
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gym.Subscribers", b =>
                {
                    ...
                    b.Property<int>("trainerIdworkerNumber")
                        .HasColumnType("int");

                    b.HasKey("subscriptionNumber");

                    b.HasIndex("trainerIdworkerNumber");
            ...
            modelBuilder.Entity("Gym.Subscribers", b =>
                {
                    b.HasOne("Gym.Staff", "trainerId")
                        .WithMany("subscribersId")
                        .HasForeignKey("trainerIdworkerNumber")
